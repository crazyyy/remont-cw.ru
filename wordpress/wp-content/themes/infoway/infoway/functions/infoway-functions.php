...
function infoway_nav_menu_items($items) {
    if (is_home()) {
        $homelink = '<li class="current_page_item">' . '<a href="' . home_url('/') . '">' . __('Главная', 'infoway') . '</a></li>';
    } else {
        $homelink = '<li>' . '<a href="' . home_url('/') . '">' . __('Главная', 'infoway') . '</a></li>';
    }
 ...
 * @param type $ih 
 */
function infoway_get_thumbnail($iw, $ih) {
    $permalink = get_permalink(get_the_ID());
    $thumb = get_post_thumbnail_id();
    $image = infoway_thumbnail_resize($thumb, '', $iw, $ih, true, 90);
 ...
 */
function infoway_get_image($width, $height) {
    $w = $width;
    $h = $height;
    global $post, $posts;
//This is required to set to Null
    ...
    $img_path = infoway_image_resize($img_source, $w, $h);
...
// Area 1, located at the top of the sidebar.
    register_sidebar(array(
        'name' => __('Правый виджет на страницах с записями', 'infoway'),
        'id' => 'primary-widget-area',
        'description' => __('Основная область виджета', 'infoway'),
        'before_widget' => '',
        'after_widget' => '',
...
// Area 2, located below the Primary Widget Area in the sidebar. Empty by default.
    register_sidebar(array(
        'name' => __('Второй правый виджет на страницах', 'infoway'),
        'id' => 'secondary-widget-area',
        'description' => __('Вторичная область виджет', 'infoway'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3><a href="#">',
        'after_title' => '</a></h3>',
    ...
    register_sidebar(array(
        'name' => __('Виджет на главной с право', 'infoway'),
        'id' => 'home-page-right-feature-widget-area',
        'description' => __('Виджет на главной странице с права', 'infoway'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => __('Первый виджет в футере', 'infoway'),
        'id' => 'first-footer-widget-area',
        'description' => __('Первая нижняя часть виджета', 'infoway'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => __('Второй виджет в футере', 'infoway'),
        'id' => 'second-footer-widget-area',
        'description' => __('Вторая нижняя часть виджета', 'infoway'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => __('Третий виджет в футере', 'infoway'),
        'id' => 'third-footer-widget-area',
        'description' => __('Третья нижняя часть виджета', 'infoway'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => __('Четвертый виджет в футере', 'infoway'),
        'id' => 'fourth-footer-widget-area',
        'description' => __('Четвертая нижняя часть виджета', 'infoway'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
