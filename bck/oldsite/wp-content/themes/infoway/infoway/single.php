  ...
  <div class="grid_16 alpha">
    <div class="content-bar">
	  ...
	  <nav id="nav-single"> <span class="nav-previous">
                            <?php previous_post_link('%link', __('<span class="meta-nav">&larr;</span> Предыдущее сообщение', 'local-business')); ?>
                        </span> <span class="nav-next">
                            <?php next_post_link('%link', __('Следующее сообщение <span class="meta-nav">&rarr;</span>', 'local-business')); ?>
                        </span> </nav>
      <!--Start Comment box-->
