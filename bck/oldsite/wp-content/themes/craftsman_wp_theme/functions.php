...
function art_add_admin() {
    ...
    add_theme_page("Craftsman WP Theme Options", "Craftsman WP Theme Options", 'edit_themes', basename(__FILE__), 'art_admin');
...
?>
<div class="wrap">
	<h2>Craftsman WP Theme Options</h2>
